...
def convert_file(file_prefix, file_in, file_out):
    with open(file_out, "w") as destination:
        with open(file_in, "r") as source:
            ...
            destination.write("////////////////////////////////////////////////////////////////////\n")
            destination.write(f"// Copyright (c) 2022 - {DATE.date().year} Egor Orachyov\n")
...
def main():
    parser = argparse.ArgumentParser("Convert `shaders` sources into acceptable hpp include files")
